...
int main (int argc, char *argv[]) {
  ...
  case 7: case 8: case 9: case 10: /* Situs or MRC/CCP4 input format determined by test functions */
    ordermode = 1;
  ...
  switch (menumode) {
  case 1: case 2: case 3: case 4: case 5: /* Situs or MRC/CCP4 format output determined by file extension */
