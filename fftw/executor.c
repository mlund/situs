...
/* $Id: executor.c,v 1.4 2012-03-13 22:12:28 wwriggers Exp $ */
#include "fftw-int.h"
#include <stdio.h>
#include <stdlib.h>

const char *fftw_version = "FFTW V" FFTW_VERSION " ($Id: executor.c,v 1.4 2012-03-13 22:12:28 wwriggers Exp $)";
